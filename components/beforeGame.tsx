...
export default function BeforeGame() {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.text}>{appTexts.beforeGame?.beforeLink&& appTexts.beforeGame?.beforeLink.replace(/\;/g, "\n")}</Text>
            ...
            <Text style={styles.text}>{appTexts.beforeGame?.afterLink&& appTexts.beforeGame?.afterLink.replace(/\;/g, "\n")}</Text>
